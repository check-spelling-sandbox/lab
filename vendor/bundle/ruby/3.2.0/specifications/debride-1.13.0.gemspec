...
Gem::Specification.new do |s|
  ...
  s.metadata = { "homepage_uri" => "https://github.com/seattlerb/debride" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<sexp_processor>.freeze, ["~> 4.17"])
